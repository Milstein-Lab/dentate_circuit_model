...
def compute_features_multiple_instances(param_array, weight_seed, model_id=None, export=False):
    ...
    if export:
        ...
        export_dynamic_model_data(context.export_file_path, weight_seed, model_config_dict,
...
def get_objectives_multiple_instances(orig_features_dict, model_id=None, export=False):
    """
    ...
    for feature_name in orig_features_dict:
        if 'loss' in feature_name:
            objectives_dict[feature_name] = np.mean(orig_features_dict[feature_name])
        else:
            summary_features_dict[feature_name] = np.mean(orig_features_dict[feature_name])
